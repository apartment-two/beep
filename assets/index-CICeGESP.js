...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:_n,depthTest:!1,depthWrite:!1})}function zo(){return new xn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ka(),fragmentShader:`
		...
		`,blending:_n,depthTest:!1,depthWrite:!1})}function Ho(){return new xn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ka(),fragmentShader:`
	...
	`}function id(i){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===Ys||c===Ks,u=c===di||c===pi;if(l||u){let h=t.get(a);const p=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==p)return e===null&&(e=new Oo(i)),h=l?e.fromEquirectangular(a,h):e.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,t.set(a,h),h.texture;if(h!==void 0)return h.texture;{const m=a.image;return l&&m&&m.height>0||u&&m&&r(m)?(e===null&&(e=new Oo(i)),h=l?e.fromEquirectangular(a):e.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,t.set(a,h),a.addEventListener("dispose",s),h.texture):null}}}return a}function r(a){let c=0;const l=6;for(let u=0;u<l;u++)a[u]!==void 0&&c++;return c===l}function s(a){const c=a.target;c.removeEventListener("dispose",s);const l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function rd(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return t[n]=r,r}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const r=e(n);return r===null&&Cr("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function sd(i,t,e,n){const r={},s=new WeakMap;function o(h){const p=h.target;p.index!==null&&t.remove(p.index);for(const _ in p.attributes)t.remove(p.attributes[_]);for(const _ in p.morphAttributes){const M=p.morphAttributes[_];for(let d=0,f=M.length;d<f;d++)t.remove(M[d])}p.removeEventListener("dispose",o),delete r[p.id];const m=s.get(p);m&&(t.remove(m),s.delete(p)),n.releaseStatesOfGeometry(p),p.isInstancedBufferGeometry===!0&&delete p._maxInstanceCount,e.memory.geometries--}function a(h,p){return r[p.id]===!0||(p.addEventListener("dispose",o),r[p.id]=!0,e.memory.geometries++),p}function c(h){const p=h.attributes;for(const _ in p)t.update(p[_],i.ARRAY_BUFFER);const m=h.morphAttributes;for(const _ in m){const M=m[_];for(let d=0,f=M.length;d<f;d++)t.update(M[d],i.ARRAY_BUFFER)}}function l(h){const p=[],m=h.index,_=h.attributes.position;let M=0;if(m!==null){const A=m.array;M=m.version;for(let S=0,y=A.length;S<y;S+=3){const N=A[S+0],R=A[S+1],T=A[S+2];p.push(N,R,R,T,T,N)}}else if(_!==void 0){const A=_.array;M=_.version;for(let S=0,y=A.length/3-1;S<y;S+=3){const N=S+0,R=S+1,T=S+2;p.push(N,R,R,T,T,N)}}else return;const d=new(Kc(p)?el:tl)(p,1);d.version=M;const f=s.get(h);f&&t.remove(f),s.set(h,d)}function u(h){const p=s.get(h);if(p){const m=h.index;m!==null&&p.version<m.version&&l(h)}else l(h);return s.get(h)}return{get:a,update:c,getWireframeAttribute:u}}function ad(i,t,e){let n;function r(p){n=p}let s,o;function a(p){s=p.type,o=p.bytesPerElement}function c(p,m){i.drawElements(n,m,s,p*o),e.update(m,n,1)}function l(p,m,_){_!==0&&(i.drawElementsInstanced(n,m,s,p*o,_),e.update(m,n,_))}function u(p,m,_){if(_===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,s,p,0,_);let d=0;for(let f=0;f<_;f++)d+=m[f];e.update(d,n,1)}function h(p,m,_,M){if(_===0)return;const d=t.get("WEBGL_multi_draw");if(d===null)for(let f=0;f<p.length;f++)l(p[f]/o,m[f],M[f]);else{d.multiDrawElementsInstancedWEBGL(n,m,0,s,p,0,M,0,_);let f=0;for(let A=0;A<_;A++)f+=m[A];for(let A=0;A<M.length;A++)e.update(f,n,M[A])}}this.setMode=r,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function od(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(e.calls++,o){case i.TRIANGLES:e.triangles+=a*(s/3);break;case i.LINES:e.lines+=a*(s/2);break;case i.LINE_STRIP:e.lines+=a*(s-1);break;case i.LINE_LOOP:e.lines+=a*s;break;case i.POINTS:e.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:n}}function cd(i,t,e){const n=new WeakMap,r=new ne;function s(o,a,c){const l=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let p=n.get(a);if(p===void 0||p.count!==h){let b=function(){I.dispose(),n.delete(a),a.removeEventListener("dispose",b)};var m=b;p!==void 0&&p.texture.dispose();const _=a.morphAttributes.position!==void 0,M=a.morphAttributes.normal!==void 0,d=a.morphAttributes.color!==void 0,f=a.morphAttributes.position||[],A=a.morphAttributes.normal||[],S=a.morphAttributes.color||[];let y=0;_===!0&&(y=1),M===!0&&(y=2),d===!0&&(y=3);let N=a.attributes.position.count*y,R=1;N>t.maxTextureSize&&(R=Math.ceil(N/t.maxTextureSize),N=t.maxTextureSize);const T=new Float32Array(N*R*4*h),I=new jc(T,N,R,h);I.type=Ye,I.needsUpdate=!0;const J=y*4;for(let x=0;x<h;x++){const z=f[x],B=A[x],k=S[x],K=N*R*4*x;for(let H=0;H<z.count;H++){const j=H*J;_===!0&&(r.fromBufferAttribute(z,H),T[K+j+0]=r.x,T[K+j+1]=r.y,T[K+j+2]=r.z,T[K+j+3]=0),M===!0&&(r.fromBufferAttribute(B,H),T[K+j+4]=r.x,T[K+j+5]=r.y,T[K+j+6]=r.z,T[K+j+7]=0),d===!0&&(r.fromBufferAttribute(k,H),T[K+j+8]=r.x,T[K+j+9]=r.y,T[K+j+10]=r.z,T[K+j+11]=k.itemSize===4?r.w:1)}}p={count:h,texture:I,size:new Ut(N,R)},n.set(a,p),a.addEventListener("dispose",b)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",o.morphTexture,e);else{let _=0;for(let d=0;d<l.length;d++)_+=l[d];const M=a.morphTargetsRelative?1:1-_;c.getUniforms().setValue(i,"morphTargetBaseInfluence",M),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",p.texture,e),c.getUniforms().setValue(i,"morphTargetsTextureSize",p.size)}return{update:s}}function ld(i,t,e,n){let r=new WeakMap;function s(c){const l=n.render.frame,u=c.geometry,h=t.get(c,u);if(r.get(h)!==l&&(t.update(h),r.set(h,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),r.get(c)!==l&&(e.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const p=c.skeleton;r.get(p)!==l&&(p.update(),r.set(p,l))}return h}function o(){r=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:s,dispose:o}}class ol extends pe{constructor(t,e,n,r,s,o,a,c,l,u=ui){if(u!==ui&&u!==bi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===ui&&(n=Bn),n===void 0&&u===bi&&(n=mi),super(null,r,s,o,a,c,u,n,l),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:oe,this.minFilter=c!==void 0?c:oe,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const cl=new pe,Go=new ol(1,1),ll=new jc,ul=new Ku,hl=new rl,Vo=[],ko=[],Wo=new Float32Array(16),Xo=new Float32Array(9),qo=new Float32Array(4);function Si(i,t,e){const n=i[0];if(n<=0||n>0)return i;const r=t*e;let s=Vo[r];if(s===void 0&&(s=new Float32Array(r),Vo[r]=s),t!==0){n.toArray(s,0);for(let o=1,a=0;o!==t;++o)a+=e,i[o].toArray(s,a)}return s}function le(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function ue(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function Xr(i,t){let e=ko[t];e===void 0&&(e=new Int32Array(t),ko[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function ud(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function hd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(le(e,t))return;i.uniform2fv(this.addr,t),ue(e,t)}}function fd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(le(e,t))return;i.uniform3fv(this.addr,t),ue(e,t)}}function dd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(le(e,t))return;i.uniform4fv(this.addr,t),ue(e,t)}}function pd(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(le(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),ue(e,t)}else{if(le(e,n))return;qo.set(n),i.uniformMatrix2fv(this.addr,!1,qo),ue(e,n)}}function md(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(le(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),ue(e,t)}else{if(le(e,n))return;Xo.set(n),i.uniformMatrix3fv(this.addr,!1,Xo),ue(e,n)}}function bd(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(le(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),ue(e,t)}else{if(le(e,n))return;Wo.set(n),i.uniformMatrix4fv(this.addr,!1,Wo),ue(e,n)}}function gd(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function _d(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(le(e,t))return;i.uniform2iv(this.addr,t),ue(e,t)}}function vd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(le(e,t))return;i.uniform3iv(this.addr,t),ue(e,t)}}function xd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(le(e,t))return;i.uniform4iv(this.addr,t),ue(e,t)}}function Md(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function Sd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(le(e,t))return;i.uniform2uiv(this.addr,t),ue(e,t)}}function Ed(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(le(e,t))return;i.uniform3uiv(this.addr,t),ue(e,t)}}function yd(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(le(e,t))return;i.uniform4uiv(this.addr,t),ue(e,t)}}function Ad(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(Go.compareFunction=Yc,s=Go):s=cl,e.setTexture2D(t||s,r)}function Td(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture3D(t||ul,r)}function wd(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTextureCube(t||hl,r)}function Rd(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture2DArray(t||ll,r)}function Cd(i){switch(i){case 5126:return ud;case 35664:return hd;case 35665:return fd;case 35666:return dd;case 35674:return pd;case 35675:return md;case 35676:return bd;case 5124:case 35670:return gd;case 35667:case 35671:return _d;case 35668:case 35672:return vd;case 35669:case 35673:return xd;case 5125:return Md;case 36294:return Sd;case 36295:return Ed;case 36296:return yd;case 35678:case 36198:case 36298:case 36306:case 35682:return Ad;case 35679:case 36299:case 36307:return Td;case 35680:case 36300:case 36308:case 36293:return wd;case 36289:case 36303:case 36311:case 36292:return Rd}}function Pd(i,t){i.uniform1fv(this.addr,t)}function Ld(i,t){const e=Si(t,this.size,2);i.uniform2fv(this.addr,e)}function Dd(i,t){const e=Si(t,this.size,3);i.uniform3fv(this.addr,e)}function Id(i,t){const e=Si(t,this.size,4);i.uniform4fv(this.addr,e)}function Ud(i,t){const e=Si(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function Nd(i,t){const e=Si(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function Fd(i,t){const e=Si(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function Od(i,t){i.uniform1iv(this.addr,t)}function Bd(i,t){i.uniform2iv(this.addr,t)}function zd(i,t){i.uniform3iv(this.addr,t)}function Hd(i,t){i.uniform4iv(this.addr,t)}function Gd(i,t){i.uniform1uiv(this.addr,t)}function Vd(i,t){i.uniform2uiv(this.addr,t)}function kd(i,t){i.uniform3uiv(this.addr,t)}function Wd(i,t){i.uniform4uiv(this.addr,t)}function Xd(i,t,e){const n=this.cache,r=t.length,s=Xr(e,r);le(n,s)||(i.uniform1iv(this.addr,s),ue(n,s));for(let o=0;o!==r;++o)e.setTexture2D(t[o]||cl,s[o])}function qd(i,t,e){const n=this.cache,r=t.length,s=Xr(e,r);le(n,s)||(i.uniform1iv(this.addr,s),ue(n,s));for(let o=0;o!==r;++o)e.setTexture3D(t[o]||ul,s[o])}function Yd(i,t,e){const n=this.cache,r=t.length,s=Xr(e,r);le(n,s)||(i.uniform1iv(this.addr,s),ue(n,s));for(let o=0;o!==r;++o)e.setTextureCube(t[o]||hl,s[o])}function Kd(i,t,e){const n=this.cache,r=t.length,s=Xr(e,r);le(n,s)||(i.uniform1iv(this.addr,s),ue(n,s));for(let o=0;o!==r;++o)e.setTexture2DArray(t[o]||ll,s[o])}function Zd(i){switch(i){case 5126:return Pd;case 35664:return Ld;case 35665:return Dd;case 35666:return Id;case 35674:return Ud;case 35675:return Nd;case 35676:return Fd;case 5124:case 35670:return Od;case 35667:case 35671:return Bd;case 35668:case 35672:return zd;case 35669:case 35673:return Hd;case 5125:return Gd;case 36294:return Vd;case 36295:return kd;case 36296:return Wd;case 35678:case 36198:case 36298:case 36306:case 35682:return Xd;case 35679:case 36299:case 36307:return qd;case 35680:case 36300:case 36308:case 36293:return Yd;case 36289:case 36303:case 36311:case 36292:return Kd}}class jd{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Cd(e.type)}}class Jd{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=Zd(e.type)}}class $d{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(t,e[a.id],n)}}}const As=/(\w+)(\])?(\[|\.)?/g;function Yo(i,t){i.seq.push(t),i.map[t.id]=t}function Qd(i,t,e){const n=i.name,r=n.length;for(As.lastIndex=0;;){const s=As.exec(n),o=As.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===r){Yo(e,l===void 0?new jd(a,i,t):new Jd(a,i,t));break}else{let h=e.map[a];h===void 0&&(h=new $d(a),Yo(e,h)),e=h}}}class Pr{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=t.getActiveUniform(e,r),o=t.getUniformLocation(e,s.name);Qd(s,o,this)}}setValue(t,e,n,r){const s=this.map[e];s!==void 0&&s.setValue(t,n,r)}setOptional(t,e,n){const r=e[n];r!==void 0&&this.setValue(t,n,r)}static upload(t,e,n,r){for(let s=0,o=e.length;s!==o;++s){const a=e[s],c=n[a.id];c.needsUpdate!==!1&&a.setValue(t,c.value,r)}}static seqWithValue(t,e){const n=[];for(let r=0,s=t.length;r!==s;++r){const o=t[r];o.id in e&&n.push(o)}return n}}function Ko(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const t0=37297;let e0=0;function n0(i,t){const e=i.split(`
`),n=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}function i0(i){const t=Yt.getPrimaries(Yt.workingColorSpace),e=Yt.getPrimaries(i);let n;switch(t===e?n="":t===Ur&&e===Ir?n="LinearDisplayP3ToLinearSRGB":t===Ir&&e===Ur&&(n="LinearSRGBToLinearDisplayP3"),i){case Mn:case Wr:return[n,"LinearTransferOETF"];case We:case za:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Zo(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),r=i.getShaderInfoLog(t).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return e.toUpperCase()+`

`+r+`

`+n0(i.getShaderSource(t),o)}else return r}function r0(i,t){const e=i0(t);return`vec4 ${i}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function s0(i,t){let e;switch(t){case su:e="Linear";break;case au:e="Reinhard";break;case ou:e="Cineon";break;case cu:e="ACESFilmic";break;case uu:e="AgX";break;case hu:e="Neutral";break;case lu:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const vr=new D;function a0(){Yt.getLuminanceCoefficients(vr);const i=vr.x.toFixed(4),t=vr.y.toFixed(4),e=vr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function o0(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ii).join(`
`)}function c0(i){const t=[];for(const e in i){const n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function l0(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(t,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),e[o]={type:s.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function Ii(i){return i!==""}function jo(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Jo(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const u0=/^[ \t]*#include +<([\w\d./]+)>/gm;function ya(i){return i.replace(u0,f0)}const h0=new Map;function f0(i,t){let e=Pt[t];if(e===void 0){const n=h0.get(t);if(n!==void 0)e=Pt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return ya(e)}const d0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function $o(i){return i.replace(d0,p0)}function p0(i,t,e,n){let r="";for(let s=parseInt(t);s<parseInt(e);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Qo(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function m0(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Uc?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Nc?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===nn&&(t="SHADOWMAP_TYPE_VSM"),t}function b0(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case di:case pi:t="ENVMAP_TYPE_CUBE";break;case kr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function g0(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case pi:t="ENVMAP_MODE_REFRACTION";break}return t}function _0(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case La:t="ENVMAP_BLENDING_MULTIPLY";break;case iu:t="ENVMAP_BLENDING_MIX";break;case ru:t="ENVMAP_BLENDING_ADD";break}return t}function v0(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function x0(i,t,e,n){const r=i.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=m0(e),l=b0(e),u=g0(e),h=_0(e),p=v0(e),m=o0(e),_=c0(s),M=r.createProgram();let d,f,A=e.glslVersion?"#version "+e.glslVersion+`
...
`,xl="data:image/png;base64,",Hn=new Q0({antialias:!0});Hn.setSize(window.innerWidth,window.innerHeight);Hn.setPixelRatio(devicePixelRatio);Hn.shadowMap.enabled=!0;Hn.shadowMap.type=Nc;document.body.appendChild(Hn.domElement);const ce=new tp;ce.background=new It(8900331);ce.fog=new Wa(8900331,100,370);const Up=new op(6993128,9072192,1.1);ce.add(Up);const Ue=new bl(16769168,2.6);Ue.position.set(80,130,50);Ue.castShadow=!0;Ue.shadow.mapSize.width=2048;Ue.shadow.mapSize.height=2048;Ue.shadow.camera.near=1;Ue.shadow.camera.far=400;Ue.shadow.camera.left=-80;Ue.shadow.camera.right=80;Ue.shadow.camera.top=80;Ue.shadow.camera.bottom=-80;Ue.shadow.bias=-3e-4;ce.add(Ue);const Ml=new bl(8960248,.4);Ml.position.set(-60,25,-40);ce.add(Ml);const Za=_p();Za.receiveShadow=!0;ce.add(Za);const Np=Mp(200);ce.add(Np);const Fp=Sp(200);ce.add(Fp);const Op=Ap(200),Ps=[],Bp=Ep(20);ce.add(Bp);const zp=yp();ce.add(zp);const Sl=xp();Sl.forEach(i=>ce.add(i));const El=new Ya(28,36,64);El.rotateX(-Math.PI/2);const yl=new ge(El,new on({color:5592405}));yl.position.y=.05;ce.add(yl);const Wi=new ap().load(xl);Wi.magFilter=oe;Wi.minFilter=oe;const Hp=dp(Ip,Wi),Al=[1911635,14042437,3832790,16107586,14713390,2795594,10181062,2500654],Ls=[29,43,83];let Ui=null;const xc=new Map,Ni=new Image;Ni.onload=()=>{const i=document.createElement("canvas");i.width=Ni.width,i.height=Ni.height;const t=i.getContext("2d");t.drawImage(Ni,0,0),Ui=t.getImageData(0,0,i.width,i.height)};Ni.src=xl;function Tl(i){const t=xc.get(i);if(t)return t;if(!Ui)return Wi;const e=i>>16&255,n=i>>8&255,r=i&255,s=new ImageData(new Uint8ClampedArray(Ui.data),Ui.width,Ui.height),o=s.data;for(let l=0;l<o.length;l+=4)Math.abs(o[l]-Ls[0])<28&&Math.abs(o[l+1]-Ls[1])<28&&Math.abs(o[l+2]-Ls[2])<28&&(o[l]=e,o[l+1]=n,o[l+2]=r);const a=document.createElement("canvas");a.width=s.width,a.height=s.height,a.getContext("2d").putImageData(s,0,0);const c=new qa(a);return c.magFilter=oe,c.minFilter=oe,c.colorSpace=Wi.colorSpace,xc.set(i,c),c}function wl(i){const t=Hp.clone();return t.traverse(e=>{if(e instanceof ge){e.castShadow=!0;const n=e.material.clone();n.map&&(n.map=i),e.material=n}}),t}let qe,Br,wa=1;const Ra=new Dp(ce),Mc=-1,Gp=-1,Sc=.25,Vp=.012,Ec=5,Ds=new D;function yc(i,t,e){for(const n of i.rolls)n.rotation.x=t;for(const n of i.fronts)n.rotation.y=e*Gp}function Ac(i,t,e){const n=Math.abs(t);if(n<=Ec)return;const r=Math.min(1,(n-Ec)/15);for(const s of i.rears)Math.random()>=r||(s.getWorldPosition(Ds),Ra.emit(Ds.x,e+.1,Ds.z,n/ki,1))}function Rl(i){const n=document.createElement("canvas");n.width=200,n.height=50;const r=n.getContext("2d");r.fillStyle="#fff",r.beginPath(),r.roundRect(3,3,194,44,7),r.fill(),r.strokeStyle="#1a1a1a",r.lineWidth=1,r.beginPath(),r.roundRect(3,3,194,44,7),r.stroke(),r.fillStyle="#111",r.font="bold 20px monospace",r.textAlign="center",r.textBaseline="middle",r.fillText(i.toUpperCase(),200/2,50/2);const s=new qa(n),o=new Xa({map:s,depthTest:!1}),a=new dl(o);return a.scale.set(1,.25,1),a.renderOrder=1,a}let zr=null;const _i=new Map,ja=new Map,Hr=new Map,Gr=new Map,Ja=new Map,kp=document.getElementById("players");function $a(i){const t=[`<div class="me">▶ ${i}</div>`];for(const e of Ja.values())t.push(`<div class="other">• ${e}</div>`);kp.innerHTML=t.join("")}function Wp(i,t,e,n){if(_i.has(i))return;const r=wl(Tl(e));r.rotation.set(0,Math.PI,0),ce.add(r),_i.set(i,r),ja.set(i,_l(r)),Hr.set(i,0);const s=Rl(t);ce.add(s),Gr.set(i,s),Ja.set(i,t),$a(n)}function Xp(i,t){const e=_i.get(i);e&&(ce.remove(e),_i.delete(i)),ja.delete(i),Hr.delete(i);const n=Gr.get(i);n&&(ce.remove(n),Gr.delete(i)),Ja.delete(i),$a(t)}const bn=new De(60,innerWidth/innerHeight,.1,500),Is=new D(0,3.5,-9),Vr=new Set;addEventListener("keydown",i=>Vr.add(i.key.toLowerCase()));addEventListener("keyup",i=>Vr.delete(i.key.toLowerCase()));const xt=bp();xt.position.set(32,0,0);xt.angle=Math.PI/2;const qp=document.getElementById("speedometer");let Tc=performance.now();const wc=new up,Yp=new D(0,-1,0);function Lr(i,t){wc.set(new D(i,20,t),Yp);const e=wc.intersectObjects([Za,...Sl]);return e.length>0?e[0].point.y:0}xt.position.y=Lr(xt.position.x,xt.position.z);const Kp=20;let mn=0,oi=!0,Rc=0,Us=0,Ns=0,Cc=0;const Zp=5,Pc=9,jp=3;let Lc=0,Fs=!1;const Dc=new D,Os=new D;function Cl(i){requestAnimationFrame(Cl);const t=Math.min((i-Tc)/1e3,.05);if(Tc=i,Fs){Vr.has("r")&&(xt.position.set(32,0,0),xt.angle=Math.PI/2,xt.speed=0,xt.velocity.set(0,0,0),mn=0,oi=!0),gp(xt,Vr,t),gc(xt,Op),Ps.length=0;for(const h of _i.values())Ps.push({x:h.position.x,z:h.position.z,r:vl});gc(xt,Ps);const{x:o,z:a}=xt.position,c=Lr(o,a);if(oi){const h=Math.sign(xt.speed||1),p=Math.sin(xt.angle)*h*.5,m=Math.cos(xt.angle)*h*.5,_=Lr(o-p,a-m),M=(c-_)/.5;xt.position.y=c,mn=M*Math.abs(xt.speed),Lr(o+p,a+m)<c-.25&&Math.abs(xt.speed)>2&&(oi=!1)}else if(mn-=Kp*t,xt.position.y+=mn*t,xt.position.y<=c){if(xt.position.y=c,oi=!0,mn<-4){const h=Math.min(16,Math.round(-mn));Ra.emit(o,c+.1,a,1,h)}mn=0}Cp(xt,i);const l=Math.sin(xt.angle),u=Math.cos(xt.angle);Dc.set(xt.position.x+Is.z*l,xt.position.y+Is.y,xt.position.z+Is.z*u),Os.lerp(Dc,1-Math.pow(.001,t)),bn.position.copy(Os),bn.lookAt(xt.position.x,xt.position.y+1,xt.position.z),qp.textContent=`${Math.abs(Math.round(xt.speed*2.24))} mph`}else{Lc+=t;const o=Math.min(Lc/Zp,1),a=o*Math.PI*2;bn.position.set(xt.position.x+Math.sin(a)*Pc,xt.position.y+.5+jp,xt.position.z+Math.cos(a)*Pc),bn.lookAt(xt.position.x,xt.position.y+1,xt.position.z),o>=1&&(Fs=!0,Os.copy(bn.position))}qe.position.set(xt.position.x,xt.position.y+.5,xt.position.z),qe.rotation.y=xt.angle+Math.PI,Rc+=xt.speed*t/wa*Mc,yc(Br,Rc,xt.wheelAngle);const e=(xt.speed-Cc)/Math.max(t,1e-4);Cc=xt.speed;const n=xt.wheelAngle*(xt.speed/ki)*Sc,r=bo.clamp(-e*Vp,-.12,.12)+(oi?0:bo.clamp(-mn*.02,-.18,.18)),s=1-Math.pow(1e-4,t);Us+=(n-Us)*s,Ns+=(r-Ns)*s,qe.rotation.z=Us,qe.rotation.x=Ns,Fs&&oi&&Ac(Br,xt.speed,xt.position.y),zr&&zr.position.set(xt.position.x,xt.position.y+2.8,xt.position.z);for(const[o,a]of Pp(i)){const c=_i.get(o);c&&(c.position.set(a.x,a.y+.5,a.z),c.rotation.y=a.angle+Math.PI,c.rotation.z=a.wheel*(a.speed/ki)*Sc);const l=ja.get(o);if(l){const h=(Hr.get(o)??0)+a.speed*t/wa*Mc;Hr.set(o,h),yc(l,h,a.wheel),Ac(l,a.speed,a.y)}const u=Gr.get(o);u&&u.position.set(a.x,a.y+2.8,a.z)}Ra.update(t),Hn.render(ce,bn)}const Jp=document.getElementById("plate-screen"),zi=document.getElementById("plate-input"),$p=document.getElementById("plate-btn");zi.addEventListener("input",()=>{zi.value=zi.value.replace(/[^a-zA-Z0-9]/g,"").toUpperCase()});let Ca=Al[0];const Ic=document.getElementById("color-row");Al.forEach((i,t)=>{const e=document.createElement("button");e.type="button",e.className="swatch"+(t===0?" selected":""),e.style.background="#"+i.toString(16).padStart(6,"0"),e.addEventListener("click",()=>{Ca=i;for(const n of Ic.children)n.classList.remove("selected");e.classList.add("selected")}),Ic.appendChild(e)});function Pl(){var e;const i=zi.value.trim();if(!i.length)return;Jp.remove(),qe=wl(Tl(Ca)),qe.rotation.order="YXZ",qe.rotation.y=Math.PI,qe.position.set(xt.position.x,xt.position.y+.5,xt.position.z),ce.add(qe),Br=_l(qe),wa=((e=Br.rolls[0])==null?void 0:e.userData.radius)??1,zr=Rl(i),ce.add(zr),$a(i),Rp("beep-beep.jbottigliero.partykit.dev","wrangler-game",i,Ca,(n,r,s)=>Wp(n,r,s,i),n=>Xp(n,i)),requestAnimationFrame(Cl)}zi.addEventListener("keydown",i=>{i.key==="Enter"&&Pl()});$p.addEventListener("click",Pl);addEventListener("resize",()=>{bn.aspect=innerWidth/innerHeight,bn.updateProjectionMatrix(),Hn.setSize(innerWidth,innerHeight)});
